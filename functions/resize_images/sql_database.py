...
def insert_paragrass_result(date_of_flight, location_of_flight, season, image_name, region_name, label, probability, logging):
    statement = 'INSERT INTO dbo.Paragrass (DateOfFlight, LocationOfFlight, Season, ImageName, RegionName, Label, Probability) VALUES (\'{0}\', \'{1}\', \'{2}\', \'{3}\', \'{4}\', \'{5}\', {6})'.format(date_of_flight, location_of_flight, season, image_name, region_name, label, probability)
    logging.info(statement)
    execute(statement)
